...
const fs = global.nodemodule["fs-extra"];
  ...
  var callback = () =>   api.sendMessage({body:`❁ ━━━━━[ 𝗨𝗜𝗗 ]━━━━━❁\n╰┈➤ 𝗡𝗔𝗠𝗘 𒁍 ${name}\n╰┈➤ 𝗜𝗗 𒁍 ${uid}\n╰┈➤ 𝗠𝗘𝗦𝗦𝗘𝗡𝗚𝗘𝗥 𝗜𝗗 𒁍 m.me/${uid}\n╰┈➤ 𝗙𝗕 𝗟𝗜𝗡𝗞 𒁍  https://www.facebook.com/profile.php?id=${uid}\n𝗠𝗔𝗗𝗘 𝗕𝗬 🍒 𝗔𝗥𝗜𝗙 𝗕𝗔𝗕𝗨`, attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID,
...
var name = res.data.result.name 
        var callback = () =>  api.sendMessage({body:`❁ ━━━━━[ 𝗨𝗜𝗗 ]━━━━━❁\n╰┈➤ 𝗡𝗔𝗠𝗘 𒁍 ${name}\n╰┈➤ 𝗜𝗗 𒁍 ${event.senderID}\n╰┈➤ 𝗠𝗘𝗦𝗦𝗘𝗡𝗚𝗘𝗥 𝗜𝗗 𒁍 m.me/${event.senderID}\n╰┈➤ 𝗙𝗕 𝗟𝗜𝗡𝗞 𒁍 https://www.facebook.com/profile.php?id=${event.senderID}\n𝗠𝗔𝗗𝗘 𝗕𝗬 🍒 𝗔𝗥𝗜𝗙 𝗕𝗔𝗕𝗨`, attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID,
        () => fs.unlinkSync(__dirname + "/cache/1.png"),event.messageID); 
